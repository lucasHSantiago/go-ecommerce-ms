...
// Source: internal/application/distributor/distributor.go
...
import (
	...
	distributor "github.com/lucasHSantiago/go-ecommerce-ms/auth/internal/application/distributor"
)
...
func (m *MockTaskDistributor) DistributeTaskSendVerifyEmail(ctx context.Context, payload *distributor.PayloadSendVerifyEmail, opts ...asynq.Option) error {
	m.ctrl.T.Helper()
