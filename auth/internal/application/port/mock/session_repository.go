...
// Source: internal/application/port/session.go
...
func (m *MockSessionRepository) CreateSession(ctx context.Context, arg port.CreateSessionParams) (*domain.Session, error) {
	m.ctrl.T.Helper()
